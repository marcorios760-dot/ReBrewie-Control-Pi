...
async def configure_device(body: ConfigureDeviceRequest) -> dict[str, Any]:
    """
    Configure the active Brewie device in memory.

    For persistence, update `.env` and restart the service.
    """
    ...
    return {
        ...
        "note": "Changes are in-memory only. Edit .env and restart for persistence.",
    }
